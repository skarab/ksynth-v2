...
# ADD CPP /nologo /W3 /GX /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /YX /FD /QIfist /c
...
# ADD LINK32 msvcrt.lib glu32.lib opengl32.lib kernel32.lib user32.lib gdi32.lib dsound.lib ksynth.lib /nologo /entry:"main" /subsystem:windows /map:"../bin/intro.map" /machine:I386 /nodefaultlib /out:"../bin/intro.exe" /MERGE:.text=.rdata
